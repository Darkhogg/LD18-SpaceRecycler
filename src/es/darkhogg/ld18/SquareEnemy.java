...
public final class SquareEnemy extends Enemy {
    ...
    public void doTick () {
        ...
        double spd = sqdist > 270 * 270 ? 15 : (sqdist > 32 * 32 ? 0.8 : 0.05);
        ...
        if (sqdist < 64 * 64 && Math.random() < 0.05) {
            game.particles.add(new SmallExplosionParticle(
                game, game.player.posX - 10 + Math.random() * 20, game.player.posY - 10 + Math.random() * 20, 12));
        }
    }
