...
public final class Debris {
	...
	public Debris ( Game game, double x, double y, Size size, int life ) {
		...
		switch ( size ) {
			case SMALL:
				selectFrom = new Image[]{
					Bitmap.DEB_SM_1.image,
					Bitmap.DEB_SM_2.image,
					Bitmap.DEB_SM_3.image,
					Bitmap.DEB_SM_4.image
				};
			break;
			case MEDIUM:
				selectFrom = new Image[]{
					Bitmap.DEB_MD_1.image,
					Bitmap.DEB_MD_2.image,
					Bitmap.DEB_MD_3.image,
					Bitmap.DEB_MD_4.image
				};
			break;
			case LARGE:
				selectFrom = new Image[]{
					Bitmap.DEB_LG_1.image,
					Bitmap.DEB_LG_2.image,
					Bitmap.DEB_LG_3.image,
					Bitmap.DEB_LG_4.image,
